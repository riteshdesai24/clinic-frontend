...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      { path: 'treatment-list', loadChildren: () => import('./treatment-list/treatment-list.module').then(m => m.TreatmentListModule) },
      { path: 'condition', loadChildren: () => import('./condition/condition.module').then(m => m.ConditionModule) },
      { path: 'medical-condition-list', loadChildren: () => import('./condition-list/condition-list.module').then(m => m.ConditionListModule) },
      { path: 'dental-condition-list', loadChildren: () => import('./condition-list/condition-list.module').then(m => m.ConditionListModule) },
